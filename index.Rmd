...
ggplot(ca_covid19, aes(x=reorder(pais, -	recuperados), y=	recuperados)) +
  ggtitle("Recuperados de COVID-19 en Centroamérica y DOM") +
  xlab("País") + 
  ylab("Recuperados") +  
  geom_col() +
...
ggplot(ca_covid19, aes(x=reorder(pais, -	activos), y=	activos)) +
  ggtitle("Activos de COVID-19 en Centroamérica y DOM") +
  xlab("País") + 
  ylab("Activos") +  
  geom_col() +
...
```{r}
# como agrupar columnas
library(reshape2)
ca_covid19melt <- melt(ca_covid19, na.rm = FALSE, value.name = "value")

# Agrupados
ggplot(ca_covid19melt, aes(fill=variable, y=value, x=pais)) + 
  geom_bar(position="dodge", stat="identity")+
   ggtitle("Datos de casos COVID-19 en Centroamérica y DOM") +
  xlab("País") + 
  ylab("Numero de Casos")

# Agrupados una sobre otra
ggplot(ca_covid19melt, aes(fill=variable, y=value, x=pais)) + 
